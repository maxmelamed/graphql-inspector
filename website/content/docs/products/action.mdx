...
Minimum severity of inline annotations (`all` by default).

| Value       | Inline annotations                                  |
| ----------- | --------------------------------------------------- |
| `all`       | All changes (breaking, dangerous, and non-breaking) |
| `dangerous` | Breaking and dangerous changes                      |
